...
This version includes changes requested by reviewers at the British Journal of Psychiatry.
...
pdf("dep 1 centrality for interpretation 0.25.pdf", width = 7)
...
# only report and interpret those which meet the stability criteria
pdf("dep 1 bridge centrality for interpretation 0.25.pdf", width = 5.5)
plot(Bridge_SS, 
